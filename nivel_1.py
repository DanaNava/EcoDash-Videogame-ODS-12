...
def run_level1(idioma_actual, volumen_actual):
    ...
    basura = [
        ...
        {"imagen": agua, "rect": agua.get_rect(topleft=(620, 400)), "nombre": {"es": "Botella de agua", "en": "Water Bottle"}, "tipo": "inorganica"},
        {"imagen": foco, "rect": foco.get_rect(topleft=(420, 640)), "nombre": {"es": "Foco", "en": "Light Bulb"}, "tipo": "peligrosa"},
        {"imagen": lata, "rect": lata.get_rect(topleft=(920, 280)), "nombre": {"es": "Lata", "en": "Can"}, "tipo": "inorganica"},
        {"imagen": manzana, "rect": manzana.get_rect(topleft=(360, 250)), "nombre": {"es": "Manzana", "en": "Apple"}, "tipo": "organica"},
        {"imagen": bateria, "rect": bateria.get_rect(topleft=(50, 600)), "nombre": {"es": "Batería", "en": "Battery"}, "tipo": "peligrosa"},
    ]

    botes = [
        {"nombre": {"es": "Inorgánico", "en": "Inorganic"}, "tipo": "inorganica", "rect": pygame.Rect(284, 155, 20, 35)},
        {"nombre": {"es": "Orgánico", "en": "Organic"}, "tipo": "organica", "rect": pygame.Rect(341, 156, 20, 35)},
        {"nombre": {"es": "Peligrosos", "en": "Hazardous"}, "tipo": "peligrosa", "rect": pygame.Rect(793, 179, 20, 20)}
    ]
