...
def run_level1():
    ...
    # --------------- IMAGENES -------------------
    #---------------------------------------------
    background = pygame.image.load("assets_PI/diseyo_nivel/nivel1/fondo_2.png").convert_alpha()
    ...
    bv = pygame.image.load("assets_PI/sprites/barra_vida_completa.png").convert_alpha()
    bv2 = pygame.image.load("assets_PI/sprites/barra_vida_2co.png").convert_alpha()
    bv1 = pygame.image.load("assets_PI/sprites/barra_vida_1co.png").convert_alpha()
    w = pygame.image.load("assets_PI/interfaces/victoria/Pantalla_victoria.jpeg").convert_alpha()
    pantalla_perdida = pygame.image.load("assets_PI/interfaces/perdida/game over 2.0.png").convert_alpha()

    # ------------- Botones -------------
    boton_win_intentar = pygame.image.load("assets_PI/interfaces/victoria/boton_intenta_otra_vez_victoria.png").convert_alpha()
    boton_win_intentar_hover = pygame.image.load("assets_PI/interfaces/victoria/boton_intenta_otra_vez_victoria_hover.png").convert_alpha()
    boton_win_menu = pygame.image.load("assets_PI/interfaces/victoria/boton_menu_pantalla_victoria.png").convert_alpha()
    boton_win_menu_hover = pygame.image.load("assets_PI/interfaces/victoria/boton_menu_hover_pantalla_victoria.png").convert_alpha()
    ...
    #------------ Personaje --------------
    personaje = pygame.image.load("assets_PI/personajes/masculino/posturas/PI_personaje_m_ver_delante.png").convert_alpha()
    ...
    # Usamos un channel específico para pasos para evitar solapes molestos
    ...
    while running:
        ...
        # sonido pasos: uso un channel para que no se superponga
        if teclas[pygame.K_LEFT] or teclas[pygame.K_RIGHT] or teclas[pygame.K_UP] or teclas[pygame.K_DOWN]:
            if not channel_walk.get_busy():
                channel_walk.play(sonido_caminar)
        ...
        if pressed_q:
           if objeto_en_mano is None:
              ...
              mensaje_tiempo = pygame.time.get_ticks()
                ...
                # chequeo botes SOLO si estoy intentando tirar
                for bote in botes:
        ...
        # dibujar objeto en la mano (si existe)
        ...
        if animando_dano:
            ...
            if animando_dano:
               ...
               rect_dano = frame.get_rect(center=personaje_draw_rect.center)
        ...
        # pantalla ganar/perder
        if ganar(basura, objeto_en_mano):
           mostrar_pantalla_victoria()

        # animacion muerte (igual que tenías, usando variables consistentes)
        if errores >= 3:
